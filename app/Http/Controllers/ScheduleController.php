...
class ScheduleController extends Controller
{
    ...
    public function generateQrCodeUpdate(Request $request, Schedule $schedule)
    {
        ...
        return view('pages.schedules.show-qrcode', compact('code'))->with('success', 'QRCode updated successfully');
        ...
        //         'code' => $request->code,
        //     ]);
        //     return view('pages.schedules.show-qrcode', compact('schedule'))->with('success', 'QRCode updated successfully');
        // } else {
        //     return redirect()->route('pages.schedules.index')->with('error', 'QRCode not found');
        // }
    }
}
